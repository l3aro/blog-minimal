                    ...
                    <div class="sm:grid sm:grid-cols-3 sm:gap-4 sm:items-start sm:border-t sm:border-gray-200 sm:pt-5">
                        ...
                        <div class="mt-1 sm:mt-0 sm:col-span-2">
                            <input type="text" wire:model.defer="user.email"
                                class="block max-w-lg w-full shadow-sm focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm border-gray-300 rounded-md">
                            <x-session-error field="user.email" />
                        </div>
                    </div>
                                ...
                                <div class="mt-4 space-y-4">
                                    <div class="flex items-center">
                                        ...
                                        <label for="level-admin"
                                            ...
                                            <input id="level-admin" name="user.is_admin" wire:model="user.is_admin" type="radio"
                                    ...
                                    <div class="flex items-center">
                                        ...
                                        <label for="level-user" class="ml-3 block text-sm font-medium text-gray-700">
                                            <input id="level-user" name="user.is_admin" wire:model="user.is_admin" type="radio"
