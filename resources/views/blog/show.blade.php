        ...
        <div class="w-full px-4 md:px-6 text-xl text-gray-800 leading-normal" style="font-family:Georgia,serif;">
            ...
            <div class="font-sans">
                <p class="text-base md:text-sm text-green-500 font-bold">&lt; <a href="#"
                        ...
                        BLOG</a></p>
                <h1 class="font-bold break-normal text-gray-900 pt-6 pb-2 text-3xl md:text-4xl">Welcome to
                    Minimal Blog</h1>
            ...
            <p class="">The basic blog page layout is available and all using the default Tailwind CSS
            ...
            <p class="">Sed dignissim lectus ut tincidunt vulputate. Fusce tincidunt lacus purus, in
            ...
            <ol>
                <li class="">Maecenas accumsan lacus sit amet elementum porta. Aliquam eu libero lectus.
                ...
                <li class="">Morbi varius posuere blandit. Praesent gravida bibendum neque eget commodo.
                ...
                <li class="">Vestibulum ante ipsum primis in faucibus orci luctus et ultrices posuere
...
&lt;/header&gt;
        ...
        <div class="my-10 lg:flex items-center p-5 border border-lighter  rounded">
            <div class="w-full lg:w-1/6 flex lg:block place-content-center lg:text-left">
                <img src="{{ asset('assets/images/htmlife.jpg') }}" class="rounded-full w-32 lg:w-full">
            </div>
            <div class="lg:pl-5 leading-loose text-center lg:text-left text-text-color w-full lg:w-5/6">
                By <span class="font-bold">Baro</span>
                <div class="text-sm">
                    <p>Software Developer with Laravel. </p>
                </div>
            </div>
        </div>
        <!--/Author-->
        ...
        <div class="flex justify-between content-center px-4 pb-12">
            <div class="text-left">
                ...
                <span class="text-xs md:text-sm font-normal text-gray-600">Previous Post Title</span><br>
            </div>
            <div class="text-right">
                ...
                <span class="text-xs md:text-sm font-normal text-gray-600">Next Post Title</span><br>
            </div>
        </div>
